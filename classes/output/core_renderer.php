...
// Define an intermediate parent class depending on whether the Moodle Workplace Extension is present or not.
// This is necessary because PHP does not allow a conditional expression in the 'extends' clause.
//
// If the Workplace extension is present, the intermediate class is defined in local_boost_union_mwp
// (so that all Workplace-specific renderer logic lives there). Otherwise, a plain fallback class is defined here.
